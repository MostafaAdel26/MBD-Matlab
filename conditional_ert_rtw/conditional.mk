###########################################################################
## Makefile generated for Simulink model 'conditional'. 
## 
## Makefile     : conditional.mk
## Generated on : Wed Feb 23 18:36:37 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/conditional.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/F_Mozakra/ITI/3_Core_courses/MBD
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = conditional_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = conditional_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/conditional.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/conditional_ert_rtw -I$(START_DIR) -ID:/F_Mozakra/ITI/1_Fundemental Courses/Matlab/Practice -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=conditional -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/conditional_ert_rtw/conditional.c

MAIN_SRC = $(START_DIR)/conditional_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/conditional_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
